...
void on_small_portrait_icon_load(const char*);
void on_portrait_icon_load(const char*);
void on_vert_portrait_icon_load(const char*);
void on_ability_icon_load(const char*);
