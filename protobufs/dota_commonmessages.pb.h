...
class CDOTAMsg_UnitOrder : public ::google::protobuf::Message {
 public:
  CDOTAMsg_UnitOrder();
  ...
  inline ::google::protobuf::int32 issuer() const;
  inline void set_issuer(::google::protobuf::int32 value);
  ...
  inline ::dotaunitorder_t order_type() const;
  inline void set_order_type(::dotaunitorder_t value);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static CDOTAMsg_UnitOrder* default_instance_;
};
// ===================================================================
...
inline ::google::protobuf::int32 CDOTAMsg_UnitOrder::issuer() const {
  // @@protoc_insertion_point(field_get:CDOTAMsg_UnitOrder.issuer)
  return issuer_;
}
inline void CDOTAMsg_UnitOrder::set_issuer(::google::protobuf::int32 value) {
  set_has_issuer();
  issuer_ = value;
  // @@protoc_insertion_point(field_set:CDOTAMsg_UnitOrder.issuer)
}
...
inline bool CDOTAMsg_UnitOrder::queue() const {
  // @@protoc_insertion_point(field_get:CDOTAMsg_UnitOrder.queue)
  return queue_;
}
inline void CDOTAMsg_UnitOrder::set_queue(bool value) {
  set_has_queue();
  queue_ = value;
  // @@protoc_insertion_point(field_set:CDOTAMsg_UnitOrder.queue)
}
