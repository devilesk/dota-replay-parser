...
void  protobuf_AddDesc_gametoolevents_2eproto();
void protobuf_AssignDesc_gametoolevents_2eproto();
void protobuf_ShutdownFile_gametoolevents_2eproto();
...
class ChangeMapToolEvent : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* mapname_;
  friend void  protobuf_AddDesc_gametoolevents_2eproto();
  friend void protobuf_AssignDesc_gametoolevents_2eproto();
  friend void protobuf_ShutdownFile_gametoolevents_2eproto();
...
class ToolTraceRayResult : public ::google::protobuf::Message {
 public:
  ...
  inline const ::CMsgVector& impact() const;
  inline ::CMsgVector* mutable_impact();
  inline ::CMsgVector* release_impact();
  inline void set_allocated_impact(::CMsgVector* impact);
  ...
  inline bool has_ehandle() const;
  inline void clear_ehandle();
  static const int kEhandleFieldNumber = 6;
  inline ::google::protobuf::int32 ehandle() const;
  inline void set_ehandle(::google::protobuf::int32 value);
...
class SpawnEntityToolEvent : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_entity_keyvalues() const;
  inline void clear_entity_keyvalues();
  static const int kEntityKeyvaluesFieldNumber = 1;
  inline const ::std::string& entity_keyvalues() const;
  inline void set_entity_keyvalues(const ::std::string& value);
  inline void set_entity_keyvalues(const char* value);
  inline void set_entity_keyvalues(const void* value, size_t size);
  inline ::std::string* mutable_entity_keyvalues();
  inline ::std::string* release_entity_keyvalues();
  inline void set_allocated_entity_keyvalues(::std::string* entity_keyvalues);

  // optional bool clientsideentity = 2;
  inline bool has_clientsideentity() const;
  inline void clear_clientsideentity();
  static const int kClientsideentityFieldNumber = 2;
  inline bool clientsideentity() const;
  inline void set_clientsideentity(bool value);
...
class ToolEvent_GetEntityInfoResult : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_cppclass() const;
  inline void clear_cppclass();
  static const int kCppclassFieldNumber = 1;
  inline const ::std::string& cppclass() const;
  inline void set_cppclass(const ::std::string& value);
  inline void set_cppclass(const char* value);
  inline void set_cppclass(const char* value, size_t size);
  inline ::std::string* mutable_cppclass();
  inline ::std::string* release_cppclass();
  inline void set_allocated_cppclass(::std::string* cppclass);
...
class ToolEvent_GetEntityInputsResult : public ::google::protobuf::Message {
 public:
  ...
  inline int input_list_size() const;
  inline void clear_input_list();
  static const int kInputListFieldNumber = 1;
  inline const ::std::string& input_list(int index) const;
  inline ::std::string* mutable_input_list(int index);
  inline void set_input_list(int index, const ::std::string& value);
  inline void set_input_list(int index, const char* value);
  inline void set_input_list(int index, const char* value, size_t size);
  inline ::std::string* add_input_list();
  inline void add_input_list(const ::std::string& value);
  inline void add_input_list(const char* value);
  inline void add_input_list(const char* value, size_t size);
  inline const ::google::protobuf::RepeatedPtrField< ::std::string>& input_list() const;
  inline ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_input_list();
...
class ToolEvent_FireEntityInput : public ::google::protobuf::Message {
 public:
  ...
  inline const ::std::string& input_param() const;
  inline void set_input_param(const ::std::string& value);
  inline void set_input_param(const char* value);
  inline void set_input_param(const char* value, size_t size);
  inline ::std::string* mutable_input_param();
  inline ::std::string* release_input_param();
  inline void set_allocated_input_param(::std::string* input_param);
...
class ToolEvent_SFMRecordingStateChanged : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_isrecording() const;
  inline void clear_isrecording();
...
inline ::CMsgVector* ToolTraceRayResult::mutable_impact() {
  set_has_impact();
  if (impact_ == NULL) impact_ = new ::CMsgVector;
...
inline void SpawnEntityToolEvent::set_entity_keyvalues(const void* value, size_t size) {
  ...
  entity_keyvalues_->assign(reinterpret_cast<const char*>(value), size);
...
inline ::std::string* SpawnEntityToolEvent::release_entity_keyvalues() {
  ...
  if (entity_keyvalues_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    ::std::string* temp = entity_keyvalues_;
...
inline void SpawnEntityToolEvent::set_allocated_entity_keyvalues(::std::string* entity_keyvalues) {
  ...
  if (entity_keyvalues) {
    set_has_entity_keyvalues();
    entity_keyvalues_ = entity_keyvalues;
  } else {
    clear_has_entity_keyvalues();
    entity_keyvalues_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
...
inline void ToolEvent_GetEntityInfoResult::set_cppclass(const ::std::string& value) {
  set_has_cppclass();
  if (cppclass_ == _default_cppclass_) {
    cppclass_ = new ::std::string;
  }
  cppclass_->assign(value);
...
inline void ToolEvent_GetEntityInfoResult::set_cppclass(const char* value, size_t size) {
  ...
  cppclass_->assign(reinterpret_cast<const char*>(value), size);
...
inline ::std::string* ToolEvent_GetEntityInfoResult::mutable_cppclass() {
  set_has_cppclass();
  if (cppclass_ == _default_cppclass_) {
    cppclass_ = new ::std::string(*_default_cppclass_);
  }
...
inline void ToolEvent_FireEntityInput::set_input_param(const ::std::string& value) {
  set_has_input_param();
  if (input_param_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    input_param_ = new ::std::string;
  }
  input_param_->assign(value);
...
inline void ToolEvent_FireEntityInput::set_input_param(const char* value, size_t size) {
  ...
  input_param_->assign(reinterpret_cast<const char*>(value), size);
