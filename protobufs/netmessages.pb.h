...
class CSVCMsg_HLTVStatus : public ::google::protobuf::Message {
 public:
  CSVCMsg_HLTVStatus();
  ...
  inline ::google::protobuf::int32 clients() const;
  inline void set_clients(::google::protobuf::int32 value);
  ...
  inline bool has_proxies() const;
  inline void clear_proxies();
  static const int kProxiesFieldNumber = 4;
  inline ::google::protobuf::int32 proxies() const;
  inline void set_proxies(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_proxies();
  inline void clear_has_proxies();
  ...
  void InitAsDefaultInstance();
  static CSVCMsg_HLTVStatus* default_instance_;
};
// -------------------------------------------------------------------
...
class ProtoFlattenedSerializerField_t : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_var_encoder_sym() const;
  inline void clear_var_encoder_sym();
  static const int kVarEncoderSymFieldNumber = 10;
  inline ::google::protobuf::int32 var_encoder_sym() const;
  inline void set_var_encoder_sym(::google::protobuf::int32 value);
